...
public class DACK {
    @Test
    //System test 01 - Đăng ký tài khoản
    public static void ST1(){
        WebDriver driver = driverFactory.getChromeDriver();
        try{
            String email = "hihihaha@gmail.com";
    ...
    // System test 4 - Đăng kí nhận tin
    @Test
    ...
    //System test 06 - Xem thông tin sản phẩm còn hàng
    @Test
    ...
    // System test 07 - Xem thông tin sản phẩm hết hàng
    @Test
    ...
    //System test 08 - Thay đổi thumbnail
    @Test
    ...
    //System test 09 - Thêm sản phẩm vào giỏ hàng - còn hàng
    @Test
    ...
    //System test 10 - Thêm sản phẩm vào giỏ hàng - hết hàng
    @Test
    ...
    //System test 11 - Xóa sản phẩm trong giỏ hàng
    @Test
    ...
    //System test 12 - Thay đổi số lượng
    @Test
    ...
    //System test 14 - Tìm kiếm thấy sản phẩm
    @Test
    ...
    //System test 14 - Tìm kiếm không thấy sản phẩm
    @Test
    ...
    // System test 16 - Lọc sản phẩm theo danh sách hiển thị
    @Test
    public static void ST16(){
        WebDriver driver = driverFactory.getChromeDriver();
        try {
            //1. Goto https://funandpeace.vn/
            driver.get("https://funandpeace.vn/");
    ...
    // System test 17 - Lọc sản phẩm theo thương hiệu
    @Test
    public static void ST17(){
        WebDriver driver = driverFactory.getChromeDriver();
        try {
            //1. Goto https://funandpeace.vn/
            driver.get("https://funandpeace.vn/");
    ...
    // System test 18 - Lọc sản phẩm theo giá sản phẩm
    @Test
    ...
    // System test 19 - Lọc sản phẩm sắp xếp theo màu sắc
    @Test
    public static void ST19(){
        WebDriver driver = driverFactory.getChromeDriver();
        try {
            //1. Goto https://funandpeace.vn/
            driver.get("https://funandpeace.vn/");
    ...
    // System test 20 - Lọc sản phẩm theo kích thước
    @Test
    public static void ST20(){
        WebDriver driver = driverFactory.getChromeDriver();
        try {
            //1. Goto https://funandpeace.vn/
            driver.get("https://funandpeace.vn/");
    ...
    //System test 21 - Xem bài viết
    @Test
    public static void ST21(){
        WebDriver driver = driverFactory.getChromeDriver();
        try {
            //1. Goto https://funandpeace.vn/
            driver.get("https://funandpeace.vn/");
